...
public class MyLibraryTest extends TestCase {
	...
	public void testMyLibrary() {
		...
		assertTrue(ml.getBooks() instanceof ArrayList);
		assertTrue(ml.getPeople() instanceof ArrayList);
	}
	...
	//ctrl + shift + p --> navigate from curly brace to curly brace
	public void testCheckOut(){
		...
		assertFalse("Book was already cheked out", ml.checkOut(b1,p2));
